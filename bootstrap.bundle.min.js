...
! function(t, e) {
    ...
    class X extends j {
        ...
        static collapseInterface(t, e) {
            ...
            const s = {...q, ...B.getDataAttributes(t), ...
                "object" == typeof e && e ? e : {}
            };
    ...
    class _e extends j {
        ...
        _getConfig(t) {
            if (t = {...this.constructor.Default, ...B.getDataAttributes(this._element), ...t
    ...
    class ye extends j {
        ...
        static jQueryInterface(t, e) {
            return this.each((function() {
                ...
                const s = {...be, ...B.getDataAttributes(this), ...
                    "object" == typeof t && t ? t : {}
                };
    ...
    class Oe extends j {
        ...
        _getConfig(t) {
            return t = {...Ae, ...B.getDataAttributes(this._element), ...
                "object" == typeof t ? t : {}
            }, l("offcanvas", t, Le), t
        }
    ...
    class Be extends j {
        ...
        _setListeners() {
            ...
            }, N.on(this._element.closest(".modal"), "hide.bs.modal", this._hideModalHandler), this.config.selector ? this.config = {...this.config, trigger: "manual", selector: ""
            } : this._fixTitle()
        }
        _fixTitle() {
        ...
        _getConfig(t) {
            ...
            return Object.keys(e).forEach(t => {
                je.has(t) && delete e[t]
            }), t && "object" == typeof t.container && t.container.jquery && (t.container = t.container[0]), "number" == typeof(t = {...this.constructor.Default, ...e, ...
                "object" == typeof t && t ? t : {}
            }).delay && (t.delay = {
                show: t.delay,
                hide: t.delay
    ...
    class Qe extends j {
        ...
        _getConfig(t) {
            return t = {...Xe, ...B.getDataAttributes(this._element), ...
                "object" == typeof t && t ? t : {}
